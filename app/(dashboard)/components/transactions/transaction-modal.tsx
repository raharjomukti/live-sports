        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Verify Transactions">
            <div className="flex gap-6">
                ...
                <div>
                    <h4 className="font-semibold text-sm mb-2">Order Details</h4>
                        <div className="bg gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5">
                            <div className="flex justify-between font-medium">
                                ...
                                <div className="text-right">22/09/2025 19:30</div>
                            </div>
                            <div className="flex justify-between font-medium">
                            ...
                            <div className="flex justify-between font-medium">
                                ...
                                <div className="text-right">+1222331313</div>
                            </div>
                    ...
                    <h4 className="font-semibold text-sm mb-2">Itmes Purchased</h4>
                    <div className="border border-gray-200 rounded-lg p-2 flex gap-2">
                        ...
                        <div className="font-medium text-sm">Sporty Live HyperFast Shoes</div>
                    ...
                    <div className="flex justify-between text-sm mt-6">
                        ...
                        <div className="text-primary font-semibold">{priceFormatter(4500000)}</div>
                    </div>
